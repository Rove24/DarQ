...
import com.kieronquinn.app.darq.ui.screens.settings.apppicker.SettingsAppPickerFragment
...
class ContainerFragment: BoundFragment<FragmentContainerBinding>(FragmentContainerBinding::inflate) {
    ...
    private fun setupToolbar(){
        with(binding){
            ...
            toolbar.setBackgroundColor(monet.getBackgroundColor(requireContext()))
            appBar.setBackgroundColor(monet.getBackgroundColor(requireContext()))
