...
abstract class DarqSharedPreferences: BaseSharedPreferences() {
    ...
    companion object {
        ...
        private const val KEY_AUTO_DARK_SCHEDULE_TYPE = "auto_dark_schedule_type"
        const val SCHEDULE_TYPE_SUNSET_SUNRISE = 0
        const val SCHEDULE_TYPE_CUSTOM = 1

        private const val KEY_AUTO_DARK_CUSTOM_START = "auto_dark_custom_start"
        const val DEFAULT_AUTO_DARK_CUSTOM_START = 22 * 60 // 22:00

        private const val KEY_AUTO_DARK_CUSTOM_END = "auto_dark_custom_end"
        const val DEFAULT_AUTO_DARK_CUSTOM_END = 7 * 60 // 07:00
    ...
    var autoDarkScheduleType by this.shared(KEY_AUTO_DARK_SCHEDULE_TYPE, SCHEDULE_TYPE_SUNSET_SUNRISE)
    var autoDarkCustomStart by this.shared(KEY_AUTO_DARK_CUSTOM_START, DEFAULT_AUTO_DARK_CUSTOM_START)
    var autoDarkCustomEnd by this.shared(KEY_AUTO_DARK_CUSTOM_END, DEFAULT_AUTO_DARK_CUSTOM_END)
