...
class UpdateChecker {
    ...
    companion object {
        private const val BASE_URL = "https://api.github.com/repos/Rove24/DarQ/"
    }
                    ...
                    this@callbackFlow.trySend(
                        Update(
                            ...
                            asset?.browserDownloadUrl
                                ?: "https://github.com/Rove24/DarQ/releases",
                            asset?.name ?: "DarQ.apk",
                            releaseUrl ?: "https://github.com/Rove24/DarQ/releases"
                        )
                    ).isSuccess
                }
            } ?: run {
