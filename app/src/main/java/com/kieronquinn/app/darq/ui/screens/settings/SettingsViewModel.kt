...
abstract class SettingsViewModel: ViewModel() {
    ...
    abstract fun onAutoDarkClicked()
...
class SettingsViewModelImpl(private val navigation: Navigation, private val settings: DarqSharedPreferences): SettingsViewModel() {
    ...
    override fun onAutoDarkClicked() {
        viewModelScope.launch {
    ...
    override fun onBackupRestoreClicked() {
        viewModelScope.launch {
            navigation.navigate(SettingsFragmentDirections.actionSettingsFragmentToSettingsDataFragment())
        }
    }
    ...
    override fun onAutoDarkThemeCheckedChange(checked: Boolean, sharedViewModel: ContainerSharedViewModel): Boolean {
        sharedViewModel.setAutoDarkThemeEnabled(checked)
        return true
    }
